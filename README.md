...
- hw5: Linear Regression Error **DONE**, Nonlinear Transforms **DONE**, Gradient Descent **DONE**, Logistic Regression (algo found in logreg.py), Perceptron Learning Algorithm as Stochastic Gradient Descent (hw5.ipynb)
